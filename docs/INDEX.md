...
2. **Testing**: Use [TEST_CREDENTIALS.md](TEST_CREDENTIALS.md) for test accounts
3. **Backend**: Reference [BACKEND_README.md](BACKEND_README.md) for API development
4. **Frontend**: Reference [FRONTEND_README.md](FRONTEND_README.md) for React development
5. **Features**: Use [BUSINESS_MANAGEMENT_GUIDE.md](BUSINESS_MANAGEMENT_GUIDE.md) for feature implementation
