  ...
  const columns = [
    {
      ...
      render: (business) => (
        <div>
          ...
          <div className="text-sm text-gray-500">{business.full_domain}</div>
        </div>
      )
    },
    {
    ...
    },
    {
      ...
      accessor: 'user_count',
      render: (business) => (
        <span className="text-sm text-gray-900">{business.user_count}</span>
      )
    },
    {
      header: 'Reservations',
      ...
      render: (business) => (
        <span className="text-sm text-gray-900">{business.reservation_count}</span>
      )
    },
    {
      header: 'Status',
    ...
    },
    {
      ...
      render: (business) => (
        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
          business.subscription_status === 'active' ? 'bg-blue-100 text-blue-800' : 'bg-yellow-100 text-yellow-800'
        }`}>
